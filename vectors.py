...
# MEGUM NOTA GRADESCOPE TIL AÐ SJÁ HVAÐ ER VITLAUST
# SKIL 3 APRÍL

def squareroot(x):
   return x**0.5

## matrix multiplication: 20 points + comments 7 points
...
# --------------------------------------------------------------------
## dot product: 10 points + comments 2 points
...
# --------------------------------------------------------------------
## cross product: 10 points + comments 3 points
...
# --------------------------------------------------------------------
## projection: 10 points + comments 3 points
...
# -------------------------------------------------------------------
## closest point: 25 points + comments 10 points
